<template>
  ...
  <div class="row">
    <Itmc-Card img-src="web.png" summary="前端主流布局系统进阶与实战，轻松解决页面布局难题" />
    <Itmc-Card img-src="go.png" summary="Google资深工程师深度讲解Go语言 由浅入深掌握Go语言">
      <template #footer>
        <div class="footer">
  ...
  <div class="row">
    <Itmc-Card img-src="java.png" :width="368" :img-height="90">
